...
bos_bus = Business.create({
    ...
    longitude: 42.6289 + rand(-2.00..2.00),
    latitude: 78.7377 + rand(-2.00..2.00), 
...
chi_bus = Business.create({
    ...
    state: 'CA', 
    zipcode: Faker::Number.number(digits: 5), 
    longitude: 41.8781 + rand(-2.00..2.00),
...
ny_bus = Business.create({
    ...
    state: 'CA', 
    zipcode: Faker::Number.number(digits: 5), 
    longitude: 40.7128 + rand(-2.00..2.00),
    latitude: 74.0060 + rand(-2.00..2.00), 
    web_address: 'www.' + Faker::Restaurant.name + '.com', 
    phone_number: Faker::PhoneNumber.cell_phone, 
    business_type: 'Restaurant' ,
    business_category: BUSINESS_CAT.sample})
...
phx_bus = Business.create({
    ...
    state: 'CA', 
    zipcode: Faker::Number.number(digits: 5), 
    longitude: 33.4484 + rand(-2.00..2.00),
    latitude: 112.0740 + rand(-2.00..2.00), 
    web_address: 'www.' + Faker::Restaurant.name + '.com', 
    phone_number: Faker::PhoneNumber.cell_phone, 
    business_type: 'Restaurant' ,
    business_category: BUSINESS_CAT.sample})
...
stl_bus = Business.create({
    ...
    state: 'AZ', 
    zipcode: Faker::Number.number(digits: 5), 
    longitude: 38.6270 + rand(-2.00..2.00),
    latitude: 90.1994 + rand(-2.00..2.00), 
    web_address: 'www.' + Faker::Restaurant.name + '.com', 
    phone_number: Faker::PhoneNumber.cell_phone, 
    business_type: 'Restaurant' ,
    business_category: BUSINESS_CAT.sample})
